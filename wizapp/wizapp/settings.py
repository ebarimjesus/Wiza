...
CMS_LANGUAGES = {(1): [{'code': 'en', 'name': gettext('English'),
    'fallbacks': ['de', 'fr'], 'public': True, 'hide_untranslated': False,
    'redirect_on_fallback': True}, {'code': 'de', 'name': gettext('German'),
    'fallbacks': ['en', 'fr'], 'public': True, 'hide_untranslated': False,
    'redirect_on_fallback': True}, {'code': 'fr', 'name': gettext('French'),
    'fallbacks': ['en', 'de'], 'public': True, 'hide_untranslated': False,
    'redirect_on_fallback': True}], 'default': {'fallbacks': ['en', 'de',
    'fr'], 'redirect_on_fallback': True, 'public': True,
    'hide_untranslated': False}}
LANGUAGE_CODE = 'en'
